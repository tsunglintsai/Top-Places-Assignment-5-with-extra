...
+ (NSArray *)topTags{
    NSLog(@"topTags:");
    NSString *request;
    request = [NSString stringWithFormat:@"http://api.flickr.com/services/rest/?method=flickr.photos.search&tags=iron man"];
    NSLog(@"%@",[self executeFlickrFetch:request]);
    
    /*
    request = [NSString stringWithFormat:@"http://api.flickr.com/services/rest/?method=flickr.photos.search&lat=37.77777&lon=-122.418251&"];
    NSLog(@"%@",[self executeFlickrFetch:request]);
    */
    request = [NSString stringWithFormat:@"http://api.flickr.com/services/rest/?method=flickr.photos.getInfo&photo_id=7704389830"];
    NSLog(@"%@",[self executeFlickrFetch:request]);
